var FormValidation = function () {
    ...
    var handleAddColorValidation = function() {
        ...
        form1.validate({
            ...
            messages: {
                name: {
                    required: jQuery.validator.format("Emri i ngjyres eshte i domosdoshem."),
                    minlength: jQuery.validator.format("Emri i ngjyres duhet te jete te pakten {0} karaktere.")
                },
                code: {
                    required: jQuery.validator.format("Kodi i ngjyres eshte i domosdoshem."),
                    minlength: jQuery.validator.format("Kodi i ngjyres duhet te jete te pakten {0} karaktere."),
                    maxlength: jQuery.validator.format("Kodi i ngjyres duhet te jete te jo me shume se {0} karaktere."),
                    regex: jQuery.validator.format("Format i gabuar i kodit.")
                }
            },
            rules: {
                name: {
...
//Validating Add payment Form
    ...
    var handleAddDebitValidation = function() {
        // for more info visit the official plugin documentation:
        // http://docs.jquery.com/Plugins/Validation

        var form1 = $('#add_debit_form');
        var error1 = $('.alert-danger', form1);
        var success1 = $('.alert-success', form1);
        ...
        form1.validate({
            ...
            messages: {
                sum: {
                    required: jQuery.validator.format("Shuma e borxhit eshte e domosdoshem.")
                },
                creditor_client: {
                    required: jQuery.validator.format("Emri i klientit kreditor eshte e domosdoshme.")
                },
                dateDebt: {
                    required: jQuery.validator.format("Data e borxhit eshte e domosdoshme.")
                }
            },
            rules: {
                sum: {
    ...
    var handleAddExpenseValidation = function() {
        // for more info visit the official plugin documentation:
        // http://docs.jquery.com/Plugins/Validation
        ...
        form1.validate({
            ...
            messages: {
                ...
                subject: {
                    required: jQuery.validator.format("Subjekti eshte e domosdoshme.")
                },
                date: {
                    required: jQuery.validator.format("Data e shpenzimit eshte e domosdoshme.")
                }
            },
            rules: {
                sum: {
    ...
    var handleValidationCourse = function() {
        // for more info visit the official plugin documentation:
        // http://docs.jquery.com/Plugins/Validation
        ...
        form1.validate({
            ...
            messages: {
                course_lev:{
                    required:'Ju lutem plotesoni kursin.',
                    number: 'Kursi duhet te jete number.'
                },
                course_lek:{
                    required:'Ju lutem plotesoni kursin.',
                    number: 'Kursi duhet te jete number.'
    ...
    return {
        ...
        init: function () {
            ...
            handleAddDebitValidation();
            handleAddExpenseValidation();
