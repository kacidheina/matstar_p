@extends('layouts.app')
@section('title') Ndrysho Klient @endsection
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-black sbold uppercase">Ndrysho Klien</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{url('update_client',$client->id)}}" id="add_client_form" method="post" class="form-horizontal">
                            {{csrf_field()}}
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name"  value="{{$client->name}}" data-required="1" class="form-control" /> </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Numer Telefoni
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" name="phone"  value="{{$client->phone}}" data-required="1" class="form-control" /> </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="city"   value="{{$client->city}}" data-required="1" class="form-control" /> </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Nipt.
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" name="nipt"  value="{{$client->nipt}}" data-required="1" class="form-control" /> </div>
                                </div>
                            </div>
                            <div class="form-body">
                                <div class="row">
